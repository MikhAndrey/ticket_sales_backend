...
urlpatterns = [
    ...
    path('api/events/announcement/<int:city_id>', EventAnnouncementView.as_view(http_method_names=['get'])),
    path('api/events/catalog/', EventCatalogView.as_view(http_method_names=['get'])),
