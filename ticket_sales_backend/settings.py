"""
Django settings for ticket_sales_backend project.
...
SECRET_KEY = 'django-insecure-t-+$97fh5!phcabb%=_%o4_4+#f9)srnkg850_)-f%!(o%kyv%'
...
ROOT_URLCONF = 'ticket_sales_backend.urls'
